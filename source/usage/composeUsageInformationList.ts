...
export function composeUsageInformationList(items: Map<string, string | undefined> = new Map(), type?: string, minNameLength = 0): string {
  ...
  items.forEach((_, name: string): void => {
