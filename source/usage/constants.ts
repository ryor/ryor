...
export const MAIN_USAGE_FOOTER: string = `Use ${bold('node [ENTRY_DIRECTORY_NAME] <runnable> -h/--help')} for detailed usage information about any runnables above that provide it.`

export const RUNNABLE_MODULE_USAGE_HEADER: string = `${bold('Usage:')} node [ENTRY_DIRECTORY_NAME] ${bold('[NAME]')} [options]`
