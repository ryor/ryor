...
export const MAIN_USAGE_FOOTER: string = `Use ${chalk.bold('node [ENTRY_DIRECTORY_NAME] <runnable> -h/--help')} for detailed usage information about any runnables above that provide it.`

export const RUNNABLE_MODULE_USAGE_HEADER: string = `${chalk.bold('Usage:')} node [ENTRY_DIRECTORY_NAME] ${chalk.bold('[NAME]')} [options]`
