describe('Checks for a valid runnable sequence', () => {
  ...
  test('returns true for individual valid runnables', () => {
    expect(isValidRunnableSequence('lint --verbose ./**/*.*')).toEqual(true)
    expect(isValidRunnableSequence(() => {})).toEqual(true)
    expect(isValidRunnableSequence(async () => {})).toEqual(true)
  })
